...
<?php if($_SESSION['time_warning'] == '1'){ ?>
	<div class="warnX" style="position:fixed; right:30px; top:30px; z-index:999999; padding:15px; width:300px; background:yellow; text-align:center;">
		Lisans süreniz <?php echo $_SESSION['time_last'];?> tarihinde sona erecektir, lütfen üyeliğinizi yenileyiniz... <br>
		<a href="javascript:;" class="closeXXX">KAPAT</a>
	</div>
<?php }?>
...
<?php if($_SESSION['time_warning'] == '2'){ ?>
	<div class="warnX" style="position:fixed; right:0px; top:0px; bottom:0; left:0; z-index:999999; padding:150px; font-size:24px; color:#fff; background:rgba(0,0,0,0.7); text-align:center;">
		Lisans süreniz sona ermiştir, lütfen üyeliğinizi yenileyiniz... <br>
		<a href="">www.sistemist.com</a><br>
		0 212 909 91 09
	</div>
<?php }?>
...
<script type="text/javascript"> 
	...
	setInterval(function(){
		$.ajax({
			type : "get",
			url : "<?php echo EXPORT_SALES_MULTI;?>",
			success : function(response){
				console.log(response);
			}
		});
