					...
					<div class="col-xs-12">
						...
						<div class="container hidden" id="printDiv2_">
							...
							<div>
								...
								<span style="float:right;display:inline-block;"> <?php echo number_format((float)0, 2, ",",".");?> ₺</span>
								<div style="clear:both;"></div>
							</div>
							<div>
...
<div id="reportModal" class="modal fade" role="dialog">
			  ...
			  <div class="modal-body">
				...
				<div class="">
					...
					<div>
						...
						<?php $row[] = array('type' => 'header', 'title' => date('d-m-Y H:i', $day['day_start_time']) .' - '.date('d-m-Y H:i', time()));?>
					</div>
					...
					<div>
						...
						<?php $row[] = array('type' => 'row', 'title' => 'İptaller Toplamı','','', 'value' => number_format(array_sum($iptal), 2,",",".").' ₺');?>
						<div style="clear:both;"></div>
					</div>
					<div>
						<span style="float:left;display:inline-block;">İndirimler Toplamı</span>
					...
					<div>
						...
						<div style="clear:both;"></div>
						<?php $row[] = array('type' => 'row', 'title' => 'İkramlar Toplamı','','', 'value' => number_format(array_sum($ikram), 2,",",".").' ₺');?>
					</div>
								...
								<div class="">
									...
									<?php foreach($proList as $key => $val){ ?>
										<div class="row">
											...
											<div class="col-xs-2"><span style="float:left;display:inline-block;"><?php echo $val['count'];?></span></div>
											<div class="col-xs-2" style="white-space:nowrap;">% <?php echo number_format((float)((($val['price']*$val['qty']*$val['count']) / $total) * 100 ), 2,",",".");?></div>
											<div class="col-xs-4"><span style="float:right;display:inline-block;"> <?php echo number_format((float)($val['price']*$val['qty']*$val['count']), 2,",",".");?> ₺</span></div>
										</div>
										<?php $row[] = array('type' => 'tableCell', 'cell1' => str_replace("'"," ",$val['pro_name']), 'cell2' => $val['count'], 'cell3' => number_format((float)((($val['price']*$val['qty']*$val['count']) / $total) * 100 ), 2,",","."), 'cell4' => number_format((float)($val['price']*$val['qty']*$val['count']), 2,",",".") );?>
									<?php } ?>
								</div>
								<div style="clear:both;"></div>
							</div>
	...
	<div class="hidden repxx">
		<div class="repp">
			...
			<?php $row2[] = array('type' => 'row', 'title' => 'İptaller Toplamı','','', 'value' => number_format(array_sum($iptal), 2,",","."));?>
