				...
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					...
					<div style="font-weight:bold;">
						...
						<?php $row[] = array('type' => 'header', 'title' => 'BulutkasaPos');?>
							...
							<div>
								<div class="">
									...
									<?php foreach($proList as $key => $val){ ?>
										...
										<div class="row">
											<div class="col-xs-4"><span style="float:left;display:inline-block;"><?php echo $val['pro_name'];?></span></div>
											<div class="col-xs-2" style="white-space:nowrap;"><?php if($val['gr'] > 0){echo $kg[$key];}?></div>
										...
										<?php $row[] = array('type' => 'tableCell', 'cell1' => str_replace("'"," ",$val['pro_name']), 'cell2' => ($val['count']), 'cell3' => number_format((float)((($val['tot_price']) / $total) * 100 ), 2,",","."), 'cell4' => number_format((float)($val['price']*$val['count']), 2,",",".") );?>
										<?php $totalKg += $kg[$key];?>
									<?php } ?>
										<div class="row" style="border-top:1px solid #000;margin-top:10px; padding-top:10px;">
											<div class="col-xs-4"><span style="float:left;display:inline-block;"><?php if($totalKg > 0){echo 'Toplam Kilo';}?></span></div>
											<div class="col-xs-2" style="white-space:nowrap;"><?php if($totalKg > 0){echo $totalKg.' Kg';}?></div>
											<div class="col-xs-2" style="white-space:nowrap;"></div>
											<div class="col-xs-2" style="white-space:nowrap;"></div>
						...
						<?php if($totalKg > 0){
							...
							$row[] = array('type' => 'header', 'title' => 'Ürün Satışları (Kg)');
							$row[] = array('type' => 'tableCell', 'cell1' => 'Urun', 'cell2' => 'Adet', 'cell3' => '', 'cell4' => 'Kg');
							$row[] = array('type' => 'line', 'title' => '------------------------------------------------');
								foreach($proList as $key => $val){
									if($val['gr']>0){
										$kg[$key] = number_format((($val['gr']*$val['count']) / 1000),2);
										
										$row[] = array('type' => 'tableCell', 'cell1' => $val['pro_name'], 'cell2' => $val['count'], 'cell4' => $kg[$key].' Kg' );
										
									}
								}
							$row[] = array('type' => 'line', 'title' => '------------------------------------------------');
							$row[] = array('type' => 'tableCell', 'cell1' => 'Toplam Kg', 'cell2' => '', 'cell3' => '', 'cell4' => $totalKg.' Kg' );
							$row[] = array('type' => 'line', 'title' => '------------------------------------------------');
						}?>
...
<div class="hidden repxx">
		<div class="repp">
			...
			<?php $row2[] = array('type' => 'header', 'title' => 'BulutkasaPos');?>
			...
			<?php $row2[] = array('type' => 'line', 'title' => '------------------------------------------------');?>
			<?php if($totalKg > 0){
				$row2[] = array('type' => 'line', 'title' => '------------------------------------------------');
				$row2[] = array('type' => 'header', 'title' => 'Ürün Satışları (Kg)');
				$row2[] = array('type' => 'tableCell', 'cell1' => 'Urun', 'cell2' => 'Adet', 'cell3' => '', 'cell4' => 'Kg');
				$row2[] = array('type' => 'line', 'title' => '------------------------------------------------');
					foreach($proList as $key => $val){
						if($val['gr']>0){
							$kg[$key] = number_format((($val['gr']*$val['count']) / 1000),2);
							
							$row2[] = array('type' => 'tableCell', 'cell1' => $val['pro_name'], 'cell2' => $val['count'], 'cell4' => $kg[$key].' Kg' );
							
						}
					}
				$row2[] = array('type' => 'line', 'title' => '------------------------------------------------');
				$row2[] = array('type' => 'tableCell', 'cell1' => 'Toplam Kg', 'cell2' => '', 'cell3' => '', 'cell4' => $totalKg.' Kg' );
				$row2[] = array('type' => 'line', 'title' => '------------------------------------------------');
			}?>
