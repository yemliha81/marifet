			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="whiteZone" style="margin-bottom:15px;">
						...
						<?php if($_SESSION['demo'] == '0'){ ?>
							<div class="">
								<?php foreach( $printers as $key => $val ){ ?>
									<div class="row updp" prid="<?php echo $val['id'];?>" prname="<?php echo $val['printer_name'];?>" prip="<?php echo $val['printer_ip'];?>" style="padding:8px; cursor:pointer;" data-target="#updatePrinterModal" data-toggle="modal">
										<div class="col-xs-6">
