		...
		<div class="tblcell">
			<form id="userForm">
				...
				<div class="text-center">
					<div class="text-center" style="padding:20px 0; font-size:18px; font-weight:bold; border-bottom:1px solid #ddd;">
						Şube Girişi
					</div>
					<div class="row" style="padding:20px 0;">
						<div class="col-xs-6">
							<div style="background:#fff; padding:15px; border-radius:10px;text-align:center; border:2px solid #EF6A26;">
								<img src="<?php echo FATHER_BASE;?>img/bkasa-logo3-01.png" width="100%">
							</div>
						</div>
						<div class="col-xs-6">
							<div style="background:#fff; padding:15px; border-radius:10px;text-align:center; border:2px solid #EF6A26;">
								<img src="<?php echo FATHER_BASE;?>img/kare-logo.png" width="100%">
							</div>
						</div>
					</div>
