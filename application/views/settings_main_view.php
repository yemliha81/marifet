...
<div class="left2" style="background:#fff;">
	<div class="mainContainer" style="padding:15px;">
		...
		<div class="col-sm-4">
			<div class="text-center" style="font-size:40px; font-weight:bold;background:#fff; padding:15px; border-radius:10px;text-align:center; border:2px solid #EF6A26;">
				<img src="<?php echo IMG;?>bkasa-logo3-01.png" width="200px" />
			</div>
		</div>
		<div class="col-sm-4"></div>
