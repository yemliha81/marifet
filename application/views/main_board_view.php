...
<div class="tbl" style="width:100%;">
	<div class="row rowx" style="margin:0;">
		...
		<div class="col-sm-4 tblx">
				...
				<a class="btnXX btn btn-<?php echo $cls;?> btn-float gotolink" link="<?php echo $this->assist->check_auth(2, KIOSK_ORDER1);?>" href="javascript:;">
					<span class="xText">SATIŞ EKRANI</span> <br />
		...
		<div class="col-sm-4 tblx" >
			<div style="background:#ff0000;color:#fff;position:absolute; top: 3px; bottom: 3px;right: 3px; left: 3px; border-radius: 3px; padding: 5px;">
				<div class="text-center" style="font-size:15px;"><b><?php echo $_SESSION['store_name'];?></b></div>
					<?php 
						$ftime = strtotime($_SESSION['time_first']);
						$ltime = strtotime($_SESSION['time_last']);
				...
				<div class="fontXX">
					<div class="col-sm-6 text-center" style="padding:0;">
						<span class="text-center"><b>Başlangıç <br /> <?php echo $_SESSION['time_first'];?></b></span>
					</div>
					<div class="col-sm-6 text-center" style="padding:0;">
						<span class="text-center"><b>Bitiş<br /><?php echo $_SESSION['time_last'];?></b></span>
					</div>
				...
				<div class="col-xs-12 text-center hidden-xs">
					<div class="row" style="padding:20px 0;">
						<div class="col-xs-6">
							<div style="background:#fff; padding:15px; border-radius:10px;text-align:center; border:2px solid #EF6A26;">
								<img src="<?php echo FATHER_BASE;?>img/bkasa-logo3-01.png" width="70%">
							</div>
						</div>
						<div class="col-xs-6">
							<div style="background:#fff; padding:15px; border-radius:10px;text-align:center; border:2px solid #EF6A26;">
								<img src="<?php echo FATHER_BASE;?>img/kare-logo.png" width="70%">
							</div>
						</div>
					</div>
				</div>
